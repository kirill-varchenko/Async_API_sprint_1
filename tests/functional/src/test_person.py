...
tasks = [('search?', {'query': '', 'page[number]': 834, 'page[size]': 5}, [
    {"uuid": "ffe0d805-3595-4cc2-a892-f2bedbec4ac6", "full_name": "Alun Davies", "role": "actor",
     "film_ids": ["7ee0af24-1b85-4406-b442-04574d41dd3b"]}], 200, 1, 'Query for full list of persons(end of list)'),
         ('search?', {'query': 'johndear'}, {"detail": "person not found"}, 404, 1, 'Query for empty list (404)'),
         ('UUID', {'UUID': '009884ca-5a33-44ba-8fba-495a0055c70d'},
          {"uuid": "009884ca-5a33-44ba-8fba-495a0055c70d", "full_name": "Mazzy Star", "role": "actor",
           "film_ids": ["6d22c585-0fca-4653-936e-302094c2adc7"]}, 200, 4, 'Query for UUID'),
         ('UUID/film', {'UUID': '0031feab-8f53-412a-8f53-47098a60ac73'},
          [{"uuid": "bfe61bd9-5dfd-41ca-80ae-8eca998bc29d", "title": "Lone Star", "imdb_rating": 7.4}], 200, 1,
          'Query for UUID + film'),
         ('search?', {'query': 'dion'}, [
             {"uuid": "d194e243-0a8c-41d1-a970-492792026f4b", "full_name": "Dion Johnstone", "role": "actor",
              "film_ids": ["6d647d21-0443-47f2-ab0c-c1aab661c9a1"]}], 200, 1, 'Query for name'),
         ('UUID', {'UUID': '31feab-8f53-412a-8f53-47098a60ac73'},
         ...
         ('search?', {'query': 'sayles', 'page[number]': 0, 'page[size]': 10}, {"detail": [
             {"loc": ["query", "page[number]"], "msg": "ensure this value is greater than or equal to 1",
...
async def test_redis(make_get_request, redis_session):
    ...
    redis_session.set('0031feab-8f53-412a-8f53-47098a60ac73', incorrect_data)
    response = await make_get_request('UUID', {'UUID': '0031feab-8f53-412a-8f53-47098a60ac73'})
    assert response.body == {"uuid": "0031feab-8f53-412a-8f53-47098a60ac73", "full_name": "Alex Malikov",
                             "role": "director, writer", "film_ids": ["bfe61bd9-5dfd-41ca-80ae-8eca998bc29d"]}
    redis_session.delete('0031feab-8f53-412a-8f53-47098a60ac73')
