...
from create_es_schema.create_index import CreateIndex
...
class Loader:
    ...
    def __init__(self, host: str):
        self.host = host
        self.create_index = CreateIndex([self.host])
        self.es = self.es_init()

    @backoff()
    def es_init(self):
        self.create_index.create_index_movies()
        self.create_index.create_index_persons()
        self.create_index.create_index_genres()
